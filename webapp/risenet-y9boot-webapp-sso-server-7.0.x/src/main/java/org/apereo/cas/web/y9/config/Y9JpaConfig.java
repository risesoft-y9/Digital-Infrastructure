...
public class Y9JpaConfig {
	...
	public BeanContainer<String> jpaServicePackagesToScan() {
		String s1 = JpaRegisteredServiceEntity.class.getPackage().getName();
		String s2 = Y9LoginUser.class.getPackage().getName();
		String s3 = Y9User.class.getPackage().getName();
		return BeanContainer.of(CollectionUtils.wrapSet(s1, s2, s3));
	}
	*/
