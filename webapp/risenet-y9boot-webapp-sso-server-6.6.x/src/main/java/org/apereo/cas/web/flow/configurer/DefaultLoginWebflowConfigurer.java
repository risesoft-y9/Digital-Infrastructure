...
public class DefaultLoginWebflowConfigurer extends AbstractCasWebflowConfigurer {
    ...
    protected void createLoginFormView(final Flow flow) {
        ...
        String casLoginView = environment.getProperty("y9.app.y9sso.casLoginView");

        // String required = environment.getProperty("y9.app.y9sso.credentialPropsRequired");
        // String[] requiredArray = required.split(",");
        // List<String> propertiesToBind = new ArrayList<String>();
        // for (String prop : requiredArray) {
        // String s = prop.trim();
        // if (s.length() > 0) {
        ...
        String optional = environment.getProperty("y9.app.y9sso.credentialPropsOptional");
