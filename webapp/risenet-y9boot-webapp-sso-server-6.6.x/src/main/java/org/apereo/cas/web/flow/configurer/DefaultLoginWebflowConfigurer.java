...
public class DefaultLoginWebflowConfigurer extends AbstractCasWebflowConfigurer {
    ...
    public DefaultLoginWebflowConfigurer(final FlowBuilderServices flowBuilderServices, final FlowDefinitionRegistry flowDefinitionRegistry, final ConfigurableApplicationContext applicationContext, final CasConfigurationProperties casProperties) {
    ...
    protected void createGatewayServicesMgmtAction(final Flow flow) {
        val gatewayServicesManagementCheck = createActionState(flow, CasWebflowConstants.STATE_ID_GATEWAY_SERVICES_MGMT_CHECK, CasWebflowConstants.ACTION_ID_GATEWAY_SERVICES_MANAGEMENT);
    ...
    protected void createGenerateServiceTicketAction(final Flow flow) {
        val handler = createActionState(flow, CasWebflowConstants.STATE_ID_GENERATE_SERVICE_TICKET, createEvaluateAction(CasWebflowConstants.ACTION_ID_GENERATE_SERVICE_TICKET));
    ...
    protected void createHandleAuthenticationFailureAction(final Flow flow) {
        val handler = createActionState(flow, CasWebflowConstants.STATE_ID_HANDLE_AUTHN_FAILURE, CasWebflowConstants.ACTION_ID_AUTHENTICATION_EXCEPTION_HANDLER);
        ...
        createTransitionForState(handler, UnauthorizedAuthenticationException.class.getSimpleName(), CasWebflowConstants.STATE_ID_AUTHENTICATION_BLOCKED);
    ...
    protected void createInitialAuthenticationRequestValidationCheckAction(final Flow flow) {
        val action = createActionState(flow, CasWebflowConstants.STATE_ID_INITIAL_AUTHN_REQUEST_VALIDATION_CHECK, CasWebflowConstants.ACTION_ID_INITIAL_AUTHN_REQUEST_VALIDATION);
    ...
    private void createInitialLoginAction(final Flow flow) {
        val state = createActionState(flow, CasWebflowConstants.STATE_ID_INIT_LOGIN_FORM, CasWebflowConstants.ACTION_ID_INIT_LOGIN_ACTION);
        createTransitionForState(state, CasWebflowConstants.TRANSITION_ID_SUCCESS, CasWebflowConstants.STATE_ID_AFTER_INIT_LOGIN_FORM);
        val afterState = createActionState(flow, CasWebflowConstants.STATE_ID_AFTER_INIT_LOGIN_FORM, createSetAction("requestScope.initialized", "true"));
        createTransitionForState(afterState, CasWebflowConstants.TRANSITION_ID_SUCCESS, CasWebflowConstants.STATE_ID_VIEW_LOGIN_FORM);
    }
    ...
    protected void createInjectHeadersActionState(final Flow flow) {
        val headerState = createActionState(flow, CasWebflowConstants.STATE_ID_HEADER_VIEW, CasWebflowConstants.ACTION_ID_INJECT_RESPONSE_HEADERS);
    ...
    protected void createLoginFormView(final Flow flow) {
        ...
        // }
        // }
        val propertiesToBind = Map.of("username", Map.of("required", "true"), "password", Map.of("converter", StringToCharArrayConverter.ID), "source", Map.of("required", "true"), "rememberMe", Map.of("required", "true"), "noLoginScreen", Map.of("required", "true"), "loginType",
    ...
    protected void createNonInteractiveLoginAction(final Flow flow) {
        val state = createActionState(flow, "nonInteractiveLoginState", "riseCredentialNonInteractiveCredentialsAction");
        ...
        createTransitionForState(state, CasWebflowConstants.TRANSITION_ID_AUTHENTICATION_FAILURE, CasWebflowConstants.STATE_ID_VIEW_LOGIN_FORM);
        createTransitionForState(state, CasWebflowConstants.TRANSITION_ID_ERROR, CasWebflowConstants.STATE_ID_VIEW_LOGIN_FORM);
    ...
    protected void createSendTicketGrantingTicketAction(final Flow flow) {
        val action = createActionState(flow, CasWebflowConstants.STATE_ID_SEND_TICKET_GRANTING_TICKET, CasWebflowConstants.ACTION_ID_SEND_TICKET_GRANTING_TICKET);
    ...
    protected void createServiceAuthorizationCheckAction(final Flow flow) {
        val serviceAuthorizationCheck = createActionState(flow, CasWebflowConstants.STATE_ID_SERVICE_AUTHZ_CHECK, CasWebflowConstants.ACTION_ID_SERVICE_AUTHZ_CHECK);
    ...
    protected void createServiceUnauthorizedCheckDecisionState(final Flow flow) {
        val decision = createDecisionState(flow, CasWebflowConstants.STATE_ID_SERVICE_UNAUTHZ_CHECK, "flowScope.unauthorizedRedirectUrl != null", CasWebflowConstants.STATE_ID_VIEW_REDIR_UNAUTHZ_URL, CasWebflowConstants.STATE_ID_VIEW_SERVICE_ERROR);
    ...
    protected void createTerminateSessionAction(final Flow flow) {
        val terminateSession = createActionState(flow, CasWebflowConstants.STATE_ID_TERMINATE_SESSION, createEvaluateAction(CasWebflowConstants.ACTION_ID_TERMINATE_SESSION));
    ...
    protected void createTicketGrantingTicketCheckAction(final Flow flow) {
        val action = createActionState(flow, CasWebflowConstants.STATE_ID_TICKET_GRANTING_TICKET_CHECK, CasWebflowConstants.ACTION_ID_TICKET_GRANTING_TICKET_CHECK);
        createTransitionForState(action, CasWebflowConstants.TRANSITION_ID_TICKET_GRANTING_TICKET_NOT_EXISTS, CasWebflowConstants.STATE_ID_GATEWAY_REQUEST_CHECK);
        createTransitionForState(action, CasWebflowConstants.TRANSITION_ID_TICKET_GRANTING_TICKET_INVALID, CasWebflowConstants.STATE_ID_TERMINATE_SESSION);
        createTransitionForState(action, CasWebflowConstants.TRANSITION_ID_TICKET_GRANTING_TICKET_VALID, CasWebflowConstants.STATE_ID_HAS_SERVICE_CHECK);
    }
    ...
    protected void createWarnDecisionState(final Flow flow) {
        createDecisionState(flow, CasWebflowConstants.STATE_ID_WARN, "flowScope.warnCookieValue", CasWebflowConstants.STATE_ID_SHOW_WARNING_VIEW, CasWebflowConstants.STATE_ID_REDIRECT);
    }
