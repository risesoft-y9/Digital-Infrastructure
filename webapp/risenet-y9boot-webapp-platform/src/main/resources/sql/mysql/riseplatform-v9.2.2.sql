...
Date: 2018-12-11 11:28:20
*/

CREATE TABLE rc8_ac_iconitem
(
    id         varchar(38) COLLATE utf8_bin NOT NULL,
    appId      varchar(38) COLLATE utf8_bin  DEFAULT NULL,
    appName    varchar(255) COLLATE utf8_bin DEFAULT NULL,
    deskIndex  int(11) DEFAULT NULL,
    folderId   varchar(38) COLLATE utf8_bin  DEFAULT NULL,
    icon       varchar(255) COLLATE utf8_bin DEFAULT NULL,
    personId   varchar(38) COLLATE utf8_bin  DEFAULT NULL,
    showHome   int(11) DEFAULT NULL,
    status     int(11) DEFAULT NULL,
    systemId   varchar(38) COLLATE utf8_bin  DEFAULT NULL,
    systemName varchar(255) COLLATE utf8_bin DEFAULT NULL,
    tabIndex   int(11) DEFAULT NULL,
    type       varchar(50) COLLATE utf8_bin  DEFAULT NULL,
    url        varchar(255) COLLATE utf8_bin DEFAULT NULL,
    PRIMARY KEY (id),
    UNIQUE KEY UKi9mas9molqcmh5ybacc97sie1 (appId,personId),
    KEY        index_Icon_personID (personId)
...
(
    ...
    PRIMARY KEY (ID),
    UNIQUE KEY UK_9o4nsyn7qvivtfxrj6cpkkykd (EMAIL),
    UNIQUE KEY UK_eb1smdaj7o51cu64wakwhaa9a (LOGINNAME),
...
(
    ...
    EVENTTARGET  varchar(255) COLLATE utf8_bin NOT NULL,
    EVENTTYPE    varchar(255) COLLATE utf8_bin NOT NULL,
    LISTENERTIME datetime(6) NOT NULL,
    OBJID        varchar(255) COLLATE utf8_bin DEFAULT NULL,
    TENANTID     varchar(255) COLLATE utf8_bin DEFAULT NULL,
    PRIMARY KEY (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
