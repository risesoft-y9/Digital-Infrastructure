...
(
    ...
    POSITION_LEADER  varchar(255) COLLATE utf8_bin  DEFAULT NULL,
    POSITION_MANAGER varchar(255) COLLATE utf8_bin  DEFAULT NULL,
    PRIMARY KEY (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(
    ...
    MENBERTYPE varchar(255) COLLATE utf8_bin DEFAULT NULL,
    MODIFYTIME datetime(6) DEFAULT NULL,
    PARENTID   varchar(100) COLLATE utf8_bin NOT NULL,
