...
CREATE TABLE RC8_COMMON_IPADDRESSWHITELIST ( ID VARCHAR ( 38 ) NOT NULL, IPADDRESS VARCHAR ( 255 ), PRIMARY KEY ( ID ) ) ENGINE = INNODB;
CREATE TABLE RC8_IMPORTXML_LOG ( ID VARCHAR ( 50 ) NOT NULL, ERRORCONTENT LONGTEXT, PRIMARY KEY ( ID ) ) ENGINE = INNODB;
...
CREATE TABLE RC8_ORG_OPTIONCLASS ( TYPE VARCHAR ( 255 ) NOT NULL, NAME VARCHAR ( 255 ) NOT NULL, PRIMARY KEY ( TYPE ) ) ENGINE = INNODB;
