...
(
    ...
    NEGATIVE          NUMBER (11, 0) DEFAULT 0,
    PRIMARY KEY (ID)
);
...
(
    ID         VARCHAR2 (50 CHAR) NOT NULL,
    ERROR      NUMBER (1, 0) DEFAULT 0 NOT NULL,
...
(
    ...
    BUREAU           NUMBER (1, 0) DEFAULT 0 NOT NULL,
    ...
    POSITION_LEADER  VARCHAR2 (255 CHAR),
    POSITION_MANAGER VARCHAR2 (255 CHAR),
    PRIMARY KEY (ID)
);
...
(
    ...
    PARENT_ID  VARCHAR2 (100 CHAR) NOT NULL,
    PERSON_ID  VARCHAR2 (100 CHAR) NOT NULL,
    PHOTO      BLOB,
    SIGN       BLOB,
    UPDATETIME TIMESTAMP,
    PRIMARY KEY (ID)
...
(
    ...
    SHAREID    VARCHAR2 (50 CHAR),
    SHARENAME  VARCHAR2 (50 CHAR),
    TABINDEX   NUMBER (10, 0),
    TENANTID   VARCHAR2 (38 CHAR),
    USERID     VARCHAR2 (38 CHAR),
    USERNAME   VARCHAR2 (50 CHAR),
    PRIMARY KEY (ID)
);
...
(
    ID         VARCHAR2 (38 CHAR) NOT NULL,
    CREATETIME TIMESTAMP NOT NULL,
    GROUPID    VARCHAR2 (38 CHAR),
    MEMBERID   VARCHAR2 (38 CHAR),
    MEMBERNAME VARCHAR2 (20 CHAR),
    MENBERTYPE VARCHAR2 (255 CHAR),
    MODIFYTIME TIMESTAMP,
    PARENTID   VARCHAR2 (100 CHAR) NOT NULL,
    SEX        NUMBER (10, 0),
    TABINDEX   NUMBER (10, 0),
    PRIMARY KEY (ID)
);
...
(
    ID         VARCHAR2 (38 CHAR) NOT NULL,
    APPID      VARCHAR2 (38 CHAR),
    APPNAME    VARCHAR2 (255 CHAR),
    DESKINDEX  NUMBER (10, 0),
    FOLDERID   VARCHAR2 (38 CHAR),
    ICON       VARCHAR2 (255 CHAR),
    PERSONID   VARCHAR2 (38 CHAR),
    SHOWHOME   NUMBER (10, 0),
    STATUS     NUMBER (10, 0),
    SYSTEMID   VARCHAR2 (38 CHAR),
    SYSTEMNAME VARCHAR2 (255 CHAR),
    TABINDEX   NUMBER (10, 0),
    ICONTYPE   VARCHAR2 (50 CHAR),
...
(
    ID            VARCHAR2 (38 CHAR) NOT NULL,
    ACTIVITYGUID  VARCHAR2 (255 CHAR),
    CONTENT       CLOB,
    CREATOR       VARCHAR2 (30 CHAR),
    CREATORGUID   VARCHAR2 (38 CHAR),
    ENDTIME       VARCHAR2 (255 CHAR),
    ISREMIND      NUMBER (10, 0),
    OTHERUSERGUID VARCHAR2 (2000 CHAR),
    OTHERUSERNAME VARCHAR2 (2000 CHAR),
    REMINDTIME    VARCHAR2 (255 CHAR),
    STARTTIME     VARCHAR2 (255 CHAR),
    TITLE         VARCHAR2 (38 CHAR),
    PRIMARY KEY (ID)
);
...
(
    ID          VARCHAR2 (255 CHAR) NOT NULL,
    CREATETIME  TIMESTAMP,
    DEPT_ID     VARCHAR2 (255 CHAR) NOT NULL,
...
(
    ID              VARCHAR2 (50 CHAR) NOT NULL,
    ORG_PERSON_ID   VARCHAR2 (255 CHAR),
    GROUP_ORDER     NUMBER (10, 0),
    ORG_POSITION_ID VARCHAR2 (255 CHAR),
    POSITIONS_ORDER NUMBER (10, 0),
    PRIMARY KEY (ID)
);
...
ALTER TABLE RC8_AC_PERSONROLE_MAPPING
    ADD CONSTRAINT UK5ja5kuivh4c866pagjn4tg1dn UNIQUE (PERSONID, ROLEID);
...
ALTER TABLE RC8_ORG_PERSON
    ADD CONSTRAINT UK_9o4nsyn7qvivtfxrj6cpkkykd UNIQUE (EMAIL);

ALTER TABLE RC8_ORG_PERSON
    ADD CONSTRAINT UK_eb1smdaj7o51cu64wakwhaa9a UNIQUE (LOGINNAME);

ALTER TABLE RC8_ORG_PERSON
    ADD CONSTRAINT UK_3flcr97cgiacatla5sthp8f8y UNIQUE (MOBILE);

ALTER TABLE RC8_ORG_PERSON_EXT
    ADD CONSTRAINT UK_2sixx2r4bm3oh87gu3ucnydks UNIQUE (PERSON_ID);

CREATE INDEX index_Icon_personID ON RC8_AC_ICONITEM (PERSONID ASC);

ALTER TABLE RC8_AC_ICONITEM
    ADD CONSTRAINT UKivgr1yifto4mll4ohrwrp5n00 UNIQUE (APPID, PERSONID);
