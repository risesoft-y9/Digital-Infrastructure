...
ALTER TABLE RC8_ORG_PERSON ADD CONSTRAINT UK_9o4nsyn7qvivtfxrj6cpkkykd UNIQUE (EMAIL);

ALTER TABLE RC8_ORG_PERSON ADD CONSTRAINT UK_eb1smdaj7o51cu64wakwhaa9a UNIQUE (LOGINNAME);

ALTER TABLE RC8_ORG_PERSON ADD CONSTRAINT UK_3flcr97cgiacatla5sthp8f8y UNIQUE (MOBILE);
...
ALTER TABLE RC8_AC_ICONITEM ADD CONSTRAINT UKivgr1yifto4mll4ohrwrp5n00 UNIQUE (APPID, PERSONID);
