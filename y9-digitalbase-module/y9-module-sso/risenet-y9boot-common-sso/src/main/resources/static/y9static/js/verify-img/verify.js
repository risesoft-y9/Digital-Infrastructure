...
(function ($, window, document, undefined) {
  ...
  Points.prototype = {
    ...
    loadDom: function () {
      ...
      panelHtml +=
        '<div class="verify-img-out"><div class="verify-img-panel"><div class="verify-refresh" style="z-index:3"><i class="iconfont icon-refresh"></i></div><canvas id="myCanvas" width="' +
    ...
    createPoint: function (pos) {
      this.htmlDoms.img_panel.append(
        '<div class="point-area" style="background-color:#4FA1D9;color:#fff;z-index:9999;width:40px;height:40px;text-align:center;line-height:40px;border-radius: 100%;position:absolute;top:' +
          parseInt(pos.y - 20) +
          "px;left:" +
          parseInt(pos.x - 20) +
          'px;">' +
