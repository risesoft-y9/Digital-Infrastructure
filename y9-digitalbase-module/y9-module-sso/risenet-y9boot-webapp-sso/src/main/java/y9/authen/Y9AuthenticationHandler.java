...
public class Y9AuthenticationHandler extends AbstractAuthenticationHandler {
	...
	public Y9AuthenticationHandler(String name, Integer order, Y9UserService y9UserService,
			Y9LoginUserService y9LoginUserService, Y9Properties y9Properties) {
	...
	public AuthenticationHandlerExecutionResult authenticate(Credential credential, Service service) throws Throwable {
		 ...
		 * customFields.get("deptId"); String rsaPublicKey = (String)
		 * customFields.get("rsaPublicKey");
		 */

		// HttpServletRequest request =
		// WebUtils.getHttpServletRequestFromExternalWebflowContext();
