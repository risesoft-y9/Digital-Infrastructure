...
dependencies {
    ...
    implementation(libs.com.oracle.database.jdbc.ojdbc17)
    implementation(libs.kingbase.kingbase8)
    implementation(libs.kingbase.kesdialect.hibernate62)
    implementation(libs.dameng.dmdialect.hibernate66)
    implementation(libs.dameng.dmjdbcdriver11)
