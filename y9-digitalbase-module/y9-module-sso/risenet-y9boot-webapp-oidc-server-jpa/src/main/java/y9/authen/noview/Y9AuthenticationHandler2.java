...
public class Y9AuthenticationHandler2 extends AbstractAuthenticationHandler {
    ...
    public Y9AuthenticationHandler2(String name, ServicesManager servicesManager, Integer order, Y9UserService y9UserService, Y9LoginUserService y9LoginUserService) {
