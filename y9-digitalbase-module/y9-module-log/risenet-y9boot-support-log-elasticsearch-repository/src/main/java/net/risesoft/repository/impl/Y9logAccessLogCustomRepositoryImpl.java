...
public class Y9logAccessLogCustomRepositoryImpl implements Y9logAccessLogCustomRepository {
    ...
    public Map<String, Object> getAppClickCount(String tenantId, String guidPath, String startDay, String endDay) {
        ...
        builder.withAggregations(AggregationBuilders.terms("by_modularname")
    ...
    public Map<String, Object> getModuleNameCount(String tenantId, String guidPath, String startDay, String endDay) {
        ...
        nativebuilder.withAggregations(AggregationBuilders.terms("by_modularname")
            .field(Y9LogSearchConsts.MODULAR_NAME)
            .size(10000)
            .order(BucketOrder.count(false)));
    ...
    public Map<String, Object> getOperateStatusCount(String selectedDate) {
        ...
        sQueryBuilder.must(QueryBuilders.rangeQuery(Y9LogSearchConsts.LOG_TIME)
            .from(DATETIME_UTC_FORMAT.format(startOfTime.getTime()))
        ...
        eQueryBuilder.must(QueryBuilders.rangeQuery(Y9LogSearchConsts.LOG_TIME)
            .from(DATETIME_UTC_FORMAT.format(startOfTime.getTime()))
            .to(DATETIME_UTC_FORMAT.format(endOfTime.getTime())));

        DateHistogramAggregationBuilder sdateHistogramAgg = AggregationBuilders.dateHistogram("by_success_logtime")
            .field(Y9LogSearchConsts.LOG_TIME)
        ...
        DateHistogramAggregationBuilder edateHistogramAgg = AggregationBuilders.dateHistogram("by_error_logtime")
            .field(Y9LogSearchConsts.LOG_TIME)
            .calendarInterval(DateHistogramInterval.HOUR)
            .timeZone(ZoneId.of("Asia/Shanghai"))
            .minDocCount(0)
    ...
    public List<Long> listOperateTimeCount(String startDay, String endDay) {
        ...
        RangeAggregationBuilder ranges = AggregationBuilders.range("range-elapsedtime")
            .field(Y9LogSearchConsts.ELAPSED_TIME)
            .addUnboundedTo(1000000)
            .addRange(1000000, 10000000)
            .addRange(10000000, 100000000)
            .addRange(100000000, 500000000)
            .addRange(500000000, 1000000000)
            .addUnboundedFrom(1000000000);
        NativeSearchQueryBuilder nativebuilder = new NativeSearchQueryBuilder();
        nativebuilder.withQuery(boolQueryBuilder);
