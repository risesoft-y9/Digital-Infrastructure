...
import net.risesoft.y9public.service.Y9AuditLogService;
...
public class AuditLogController {
    ...
    public Y9Page<Y9AuditLog> list(Y9PageQuery y9PageQuery) {
        Page<Y9AuditLog> y9AuditLogPage = y9AuditLogService.page(y9PageQuery);
