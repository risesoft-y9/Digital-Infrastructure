...
public interface Y9OrgBasesToRolesService {
     ...
     * @return {@code List<Y9OrgBasesToRoles>}
     */
    List<OrgBasesToRoles> addManagableOrgUnitsForRole(String roleId, List<String> orgIds, Boolean negative);
    ...
    /**
     * 根据roleId获取当前登录管理员可管理的映射节点
     *
     * @param roleId 角色id
     * @return {@code List<Y9OrgBasesToRoles>}
     */
    List<OrgBasesToRoles> listManagableByRoleId(String roleId);
