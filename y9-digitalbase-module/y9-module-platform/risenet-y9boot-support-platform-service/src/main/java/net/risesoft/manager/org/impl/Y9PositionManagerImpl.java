...
public class Y9PositionManagerImpl implements Y9PositionManager {
    ...
    @Override
    public String buildName(String jobName, List<Person> personList) {
        String personNames;
        ...
        if (personList.isEmpty()) {
            ...
            personNames = personList.stream()
                .sorted((Comparator.comparing(Person::getOrderedPath)))
                .map(OrgUnit::getName)
    ...
    public Y9Position update(Y9Position position) {
        ...
        Y9Position originY9Position = PlatformModelConvertUtil.convert(currentPosition, Y9Position.class);
    ...
    public Y9Position updateTabIndex(String id, int tabIndex) {
        ...
        Y9Position updatedPosition = PlatformModelConvertUtil.convert(position, Y9Position.class);
