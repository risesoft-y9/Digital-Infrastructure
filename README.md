...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/version-v9.6.2-yellow.svg">
...
数字底座是一款面向大型政府、企业，基于身份认证、组织架构、岗位职务、应用系统、资源角色等功能构建的统一且安全的管理支撑平台。数字底座基于三员管理模式，支持拓展多租户，允许用户利用代码生成器快速构建自己的业务应用，同时可以拓展诸多成熟且好用的内部生态应用。
