...
| 序号&nbsp;&nbsp; | 专利号            | 专利名称                                           |
| ---------------- | ----------------- | -------------------------------------------------- |
| 1                | ZL 202111207338.0 | 《基于集合运算的资源授权方法及资源授权系统》       |
| 2                | ZL 202210702228.X | 《一种静默化数据处理方法及处理系统》               |
| 3                | ZL 202310030893.3 | 《基于多租户模式下的权限调度方法及调度系统》       |
| 4                | ZL 202310238451.8 | 《一种基于前后端分离架构的前端双随机多态混淆方法》 |
| 5                | ZL 202310238534.7 | 《多租户模式下数字底座子域三员架构模型的实现方法》 |
=======
| 序号&nbsp; | 专利号              | 专利名称                                           |
| ---------- | ------------------- | -------------------------------------------------- |
...
>>>>>>> branch 'main' of https://svn.youshengyun.com:3000/risesoft/y9-digitalbase.git
