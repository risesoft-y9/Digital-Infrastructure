 ...
 * @since 9.6.0
 */
@FeignClient(contextId = "UserLoginInfoApiClient", name = "${y9.service.log.name:log}", url = "${y9.service.log.directUrl:}",
    path = "/${y9.service.log.name:log}/services/rest/v1/userLoginInfo")
