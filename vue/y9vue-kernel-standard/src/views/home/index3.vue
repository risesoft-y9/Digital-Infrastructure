                ...
                <div class="left">
                    ...
                    <el-card class="box-card left-two" style="background-color: #fff;">
                        <div class="card-header">
                            ...
                            <el-dropdown>
                                <el-button disabled :size="fontSizeObj.buttonSize" :style="{'font-size': fontSizeObj.baseFontSize}">
                                    {{ $t("最近一个月") }}
                                </el-button>
                                <!-- <el-button>
                        ...
                        <el-col :span="spanValue">
                            <el-card class="box-card">
                                <div class="card-header">
                                    ...
                                    <el-dropdown>
                                        <el-button :size="fontSizeObj.buttonSize" :style="{'font-size': fontSizeObj.baseFontSize}" >
                        ...
                        <el-card class="box-card">
                            ...
                            <div class="card-content"  v-loading="loading">
                                <div class="content-left">
                                    ...
                                    <el-button :size="fontSizeObj.buttonSize" :style="{'font-size': fontSizeObj.baseFontSize}" 
                                     type="primary">{{ $t("进入详情") }}<i class="ri-arrow-right-s-line"></i></el-button>
                                </div>
                                <div>
                                    <!-- echarts图表 -->
