...
<template>
    ...
    <el-container>
        <el-aside width="33%" class="grid-content bg-primary-color" style="margin-right: 20px;"></el-aside>
    ...
    <el-row :gutter="20">
        ...
        <el-col :span="18">
            <div
                ...
                style="padding-top: 45px;padding-bottom: 27px;"
            >
                <el-steps :active="4" align-center>
                    <el-step title="起草" description="开始" />
                    <el-step title="审批" description="并行" />
                    <el-step title="审批" description="串行" />
                    <el-step title="审批" description="串行" />
                    <el-step title="审批" description="并行" />
                    <el-step title="审批" description="并行" />
                    <el-step title="签发" description="结束" />
                </el-steps>
                <el-steps :active="4" simple style="margin-top:15px;padding: 13px 4%;">
                    <el-step title="王洪哲" :icon="Right" />
                    <el-step title="胡弘祚" :icon="Switch" />
                    <el-step title="张三" :icon="Right" />
                    <el-step title="李四" :icon="Right" />
                    <el-step title="王五" :icon="Switch" />
                    <el-step title="曲金凤" :icon="Switch" />
                    <el-step title="叶海峰" :icon="Right" />
                </el-steps>
            </div>
        </el-col>
    </el-row>
        ...
        <el-col :span="18">
            <div class="grid-content bg-white-color" style="padding:45px;padding-bottom: 22px;">
                <el-form :model="form" label-width="120px">
                    <el-form-item label="企业名称" :size="settingStore.getFontSize">
                        <el-input v-model="form.name" />
                    </el-form-item>
                    <el-form-item label="所属地选择" :size="settingStore.getFontSize">
                    ...
                    <el-form-item label="注册有效期" :size="settingStore.getFontSize">
                        <el-col :span="11">
                            <el-date-picker
                                v-model="form.date1"
                                type="date"
                    ...
                    <el-form-item label="申请副理事单位" :size="settingStore.getFontSize">
                        <el-switch v-model="form.delivery" />
                    </el-form-item>
                    <el-form-item label="企业类型" :size="settingStore.getFontSize">
                    ...
                    <el-form-item label="参与联盟专题" :size="settingStore.getFontSize">
                    ...
                    <el-form-item label="备注信息" :size="settingStore.getFontSize">
    ...
    <el-row :gutter="20">
        <el-col :span="15">
            <div
                class="grid-content bg-white-color"
                style="padding: 25px;padding-left: 40px;padding-right: 40px;"
            >
                <div class="y9-collapse">
                    <el-collapse v-model="activeName" accordion>
                        <el-collapse-item title="五年时光如沙似画 雄安绘芳华" name="1">
                            <div>
                        ...
                        <el-collapse-item title="春已至花已开 盼疫散愿人安 " name="2"></el-collapse-item>
                        <el-collapse-item title="蓝天保卫战三年行动计划期间我国大气环境持续改善" name="3"></el-collapse-item>
                        <el-collapse-item title="韩国两架军机相撞后双双坠毁 目击者拍下现场画面" name="4"></el-collapse-item>
                        <el-collapse-item title="支援疫情防控，京检青年在行动！" name="5"></el-collapse-item>
                        <el-collapse-item title="市委决定：肖丹任海淀区委常委" name="6"></el-collapse-item>
                        <el-collapse-item title="清明假期北京市属公园推出19项主题活动" name="7"></el-collapse-item>
                        <el-collapse-item title="贵州赫章：人间奇迹 悬崖公路" name="8"></el-collapse-item>
                        <el-collapse-item title="新芽吐翠满眼绿——黔山贵水春茶采摘正当时" name="9"></el-collapse-item>
                        <el-collapse-item title="途经毕节的这条高速已基本建成" name="10"></el-collapse-item>
                    </el-collapse>
                </div>
            </div>
        </el-col>
            ...
            <div class="grid-content bg-white-color">
                <div class="y9-table">
                    <el-table :data="tableData" style="width: 100%">
                        ...
                        <el-table-column align="center" prop="state" label="省市" width="160" />
                        <el-table-column align="center" prop="city" label="市区" width="180" />
                        <el-table-column align="center" prop="address" label="地址" width="420" />
                        <el-table-column align="center" prop="zip" label="邮政编号" width="180" />
