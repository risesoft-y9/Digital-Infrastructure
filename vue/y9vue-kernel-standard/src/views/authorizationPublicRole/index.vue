...
-->
<template>
    <fixedTreeModule ref="fixedTreeRef" :treeApiObj="treeApiObj" @onTreeClick="handlerTreeClick">
...
<script lang="ts" setup>
    ...
    import { getPublicRoleTree, publicTreeSearch, roleTreeList, saveOrUpdate } from '@/api/role/index';
