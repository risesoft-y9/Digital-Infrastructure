...
public interface Y9CustomGroupMembersRepository
    ...
    Y9CustomGroupMember findByGroupIdAndMemberId(String groupId, String memberId);
    ...
    Y9CustomGroupMember findByMemberIdAndGroupId(String memberId, String groupId);
