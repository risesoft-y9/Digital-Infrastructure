...
public interface Y9logUserLoginInfoService {
    ...
    Y9Page<Y9logUserLoginInfo> page(String userHostIp, String userId, String success, String startTime, String endTime, int page, int rows);
    ...
    Y9Page<Y9logUserLoginInfo> pageByUserHostIpAndUserIdAndTenantIdAndLoginTime(String hostIp, String personId, String tenantId, String success, String startTime, String endTime, int page, int rows);
